...
However, it doesn't have to be as dramatic as that. Insights can come from recording user behavior and data. Here's a cute anecdote often retold in business schools: 
