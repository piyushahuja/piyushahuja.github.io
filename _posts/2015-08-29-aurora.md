...
As the end of my internship approached, I had to explain the RES Support work to Ben and Hanns, ex-McKinsey consultants were working remotely from Germany.

I prepared a writeup for them explaining the features of the model and the logic behind certain approximations/guesstimates I had made in the model.  And then I asked Ben to go through it before we had a conversation. I also extensively commented on the data loading code I had written and annotated all the excel files if anyone were to use the work I had done in the future.

Initially, I felt Ben and Hanns had reservations about the RES model. I could understand their incredulity -  the work I had done required a detailed understanding of the German energy policy, and not only did I have no prior experience in the energy sector - I didn't even know German! 

Over the course of making them familar with the the intricacies of the model, I realised that that Ben and I deviated on our interpretion of a particular aspect of the policy. Some parts of the policy were ambiguous - and could have only become clear when you looked at the actual, real-world data generated from the implementation of the policy in practice - and *I had worked closely with the data*. 

Once I corrected them, and they verified that my reading of the policy was correct, I had their trust and respect.  They seemed reassured that I did pay attention to all the nuances of the policy. They became more engaged with what I was explaining, asked more questions, and also followed up frequently on different aspects of the policy which they wanted to understand. All was well. 
...
I would be remiss not to mention [Florian Habermacher](http://habermacher.net/). I couldn't have asked for a better mentor and manager. Just being in the same room as him elevates your spirit. Many a times towards the end of the RES support work, I rushed the deliverable to Florian only to have some sanity check of my forecast fail. But he was ever supportive. (Interestingly, we have a long standing connection - Florian was an exchange student in IIT Delhi back in his undergrad days!) 
