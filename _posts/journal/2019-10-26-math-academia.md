...
For a brief while a year ago, while preparing for job interviews,  I took up maths once again and started working through some CS proofs and problems. Freed from any external pressure of exams or promise of external rewards, I pursued maths for its own sake, and found it to be an experience aking to meditation. It filled with purpose and inner fulfilment. Whenever I reached a point of clarity and understanding on a problem, I felt a moral happiness that I realised I hadn’t experienced in a while, that I do not experience in any other activities. 
