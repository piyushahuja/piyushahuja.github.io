...
People who order food online demand consistent quality but also get very quickly bored if the items are repeated. So the operations team changed the menu day-to-day and also experimented with new products. [^newFood] They would plan their menu such that it certain minimum requirements of profitability, diversity, and performance.
...
With Meals well on its way to profitability, I turned my attention to other verticals. 
...
Jugnoo had a “sink or swim”  onboarding strategy. One was expected to hit the ground running. So when I joined, within my first week, I was tasked with launching our subscription feature. I was assigned a team of seven and a deadline of two weeks. So Jugnoo Star became the first feature I shipped.[^star] 
...
In those two weeks, I familiarized myself with every part of the product, made user journeys, wireframes, mockups and detailed user-stories for the team. We had the approval of offering free delivery on groceries, and cashbacks on meals (8%) and restaurant delivery (2%).  The initial pricing  was (Rs. 99 for monthly subscription and Rs. 499 for annual) as a day-one hypothesis. We did no marketing and no PR. 

Initially, only a few signed up. One very enthusiastic customer was my mother. 
...
I caved in and asked the entire Jugnoo product team to sign up. Most did. And left the program within a month - without any transactions. 
...
**AskLocal: Engaging customers with content**
...
**Solving problems through design and thinking out of the box**


Our checkout page was long: one had to scroll to the end to verify that all inputs were correct: the cart, payment mode, discounts availed etc. It seemed an inefficient to me that our power users - those who were frequent users, had everything prefilled and just wanted to order as quickly as possible had to scroll all the way down to the bottom to get to the "Pay" button. I wanted the button to appear when the screen loads and float on top of the page. 

This failed basic usability testing. Users - especially new users, were trigger happy -  when they saw a call to action, they would click on it, regardless of whether they had correct checkout information prefilled or not. So we were back to the old design with its  compulsory scrolling, and I was not happy.

Could we find a way to allow our power users a quicker checkout experience AND prevent trigger0happy users to prevent the Pay button by mistake? The answer, it turned out, was YES.
...
The new design was a resounding success.  It seemed that the effort to pull the slider to the right forced the users - even those who unthinkingly press the red button -  into a more considered and deliberative mode of interaction with the app. Even better - the users found the slider experience pleasant.



**Enrollment and Training of New Drivers**


I also shipped two major features on the Driver app: (1) a revamp the onboarding and enrollment process for new drivers to make it much easier for drivers to self-enroll, and (2) an in-app tutorial for drivers which simulated an actual ride: from first request to fare collection.

However, these features were not used as much as one would have liked.  Our driver registrations increased from 10,000 when I started to 22000 by the time I left, but the credit lay to a sustained enrollment push than to any product features. 



**Summary**

I worked at Jugnoo for a little over eight months. I went from something as simple as redesigning buttons to launching new product verticals; my team grew from five to fifteen, including Android, iOS, Backend and QA engineers; I mentored new product managers, and I also had my first experience of firing someone. 

***

*If you would like to talk about the economics of food delivery, or on-demand services industry in general, please don't hesitate to reach out to me.* 
