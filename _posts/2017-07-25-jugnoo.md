...
Since the product still needed to be polished, we decided to do a waitlisted launch and only gradually open it to users. Our hope was that this would create a 'buzz' and eventually drive a lot of traffic, but it didn't pan out that way. e did a city-by-city launch and did some minor PR. 
