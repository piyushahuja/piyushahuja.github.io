...
Before I took over the our Meals product, we were following a  . Orders were aggregated beforehand for breakfast, lunch and dinner time slots.  Ordering window was closed 15 mins before the start of a slot time and delivery personel were dispatched. There were many benefits to this model. It allowed us to control delivery costs by clubbing orders together and optimising routes. Since we demand was completely determined before the delivery personell were dispatched, wastage was less.  Both these factors allowed us to keep our prices.  We appealed to customers who were budget-sensitive and planned their lunches and dinners beforehand. 
